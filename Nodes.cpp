...
bool Nodes::Getalreadysee()
{
    return alreadysee;
}

void Nodes::Setseealready(bool a)
{
    alreadysee = a;
}

int Nodes::GetdistMin()
{
    return distMin;
}

void Nodes::SetMindist(int d)
{
    distMin = d;
}

Nodes* Nodes::GetlastVisited()
{
    return lastVisited;
}

void Nodes::SetVisitedLast(Nodes* n)
{
    lastVisited = n;
}
